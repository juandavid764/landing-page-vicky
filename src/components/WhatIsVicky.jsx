      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#E1DEE9] rounded-2xl p-8 shadow-lg">
              <div className="bg-[#393939] rounded-xl p-6 mb-6">
                ...
                <div className="flex items-center justify-center space-x-1 py-8">
                  {[...Array(20)].map((_, i) => (
                    <div
                      key={i}
                      className="bg-[#55D39E] rounded-full animate-pulse"
                      style={{
                        width: '4px',
                  ...
                  <div className="ml-4 w-12 h-12 bg-[#461F9C] rounded-full flex items-center justify-center">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#393939] max-w-3xl mx-auto mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            <div className="w-20 h-20 bg-[#55D39E] rounded-2xl mx-auto mb-6 flex items-center justify-center">
          ...
          <div className="text-center">
            <div className="w-20 h-20 bg-[#816CAF] rounded-2xl mx-auto mb-6 flex items-center justify-center">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center">
            <div className="w-20 h-20 bg-[#9882CC] rounded-2xl mx-auto mb-6 flex items-center justify-center">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-[#E1DEE9] rounded-2xl p-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-[#461F9C] mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 bg-white rounded-lg p-4 shadow-sm">
                <svg className="w-5 h-5 text-[#55D39E]" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-[#393939]">Disponible 24/7</span>
              </div>
              ...
              <div className="flex items-center space-x-3 bg-white rounded-lg p-4 shadow-sm">
                ...
                <span className="text-[#393939]">5 veces más barato que un call center</span>
              </div>
              ...
              <div className="flex items-center space-x-3 bg-white rounded-lg p-4 shadow-sm">
                ...
                <span className="text-[#393939]">Manejamos servicio al cliente, ventas y generación de leads</span>
              </div>
